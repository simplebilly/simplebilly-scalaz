...
The package is published to the Scala (Scalaz) package registry. See the
[Releases](https://github.com/simplebilly/simplebilly-scalaz/releases) page for the list
of versions.
