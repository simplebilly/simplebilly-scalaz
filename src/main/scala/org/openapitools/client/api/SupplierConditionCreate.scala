...
import SupplierConditionCreate._
...
object SupplierConditionCreate {
  import DateTimeCodecs._

  implicit val SupplierConditionCreateCodecJson: CodecJson[SupplierConditionCreate] = CodecJson.derive[SupplierConditionCreate]
  implicit val SupplierConditionCreateDecoder: EntityDecoder[SupplierConditionCreate] = jsonOf[SupplierConditionCreate]
  implicit val SupplierConditionCreateEncoder: EntityEncoder[SupplierConditionCreate] = jsonEncoderOf[SupplierConditionCreate]
}
