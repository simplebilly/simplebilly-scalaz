...
object ProductCreate {
  ...
  implicit val ProductCreateCodecJson: CodecJson[ProductCreate] = CodecJson.derive[ProductCreate]
  implicit val ProductCreateDecoder: EntityDecoder[ProductCreate] = jsonOf[ProductCreate]
  implicit val ProductCreateEncoder: EntityEncoder[ProductCreate] = jsonEncoderOf[ProductCreate]
}
