...
object ServiceJob {
  ...
  implicit val ServiceJobCodecJson: CodecJson[ServiceJob] = CodecJson.derive[ServiceJob]
  implicit val ServiceJobDecoder: EntityDecoder[ServiceJob] = jsonOf[ServiceJob]
  implicit val ServiceJobEncoder: EntityEncoder[ServiceJob] = jsonEncoderOf[ServiceJob]
}
