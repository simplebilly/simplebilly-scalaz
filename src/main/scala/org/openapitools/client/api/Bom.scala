...
object Bom {
  ...
  implicit val BomCodecJson: CodecJson[Bom] = CodecJson.derive[Bom]
  implicit val BomDecoder: EntityDecoder[Bom] = jsonOf[Bom]
  implicit val BomEncoder: EntityEncoder[Bom] = jsonEncoderOf[Bom]
}
