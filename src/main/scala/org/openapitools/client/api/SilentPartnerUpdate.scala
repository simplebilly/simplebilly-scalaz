...
object SilentPartnerUpdate {
  import DateTimeCodecs._

  implicit val SilentPartnerUpdateCodecJson: CodecJson[SilentPartnerUpdate] = CodecJson.derive[SilentPartnerUpdate]
  implicit val SilentPartnerUpdateDecoder: EntityDecoder[SilentPartnerUpdate] = jsonOf[SilentPartnerUpdate]
  implicit val SilentPartnerUpdateEncoder: EntityEncoder[SilentPartnerUpdate] = jsonEncoderOf[SilentPartnerUpdate]
}
