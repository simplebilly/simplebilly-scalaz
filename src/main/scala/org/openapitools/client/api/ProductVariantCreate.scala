...
object ProductVariantCreate {
  ...
  implicit val ProductVariantCreateCodecJson: CodecJson[ProductVariantCreate] = CodecJson.derive[ProductVariantCreate]
  implicit val ProductVariantCreateDecoder: EntityDecoder[ProductVariantCreate] = jsonOf[ProductVariantCreate]
  implicit val ProductVariantCreateEncoder: EntityEncoder[ProductVariantCreate] = jsonEncoderOf[ProductVariantCreate]
}
