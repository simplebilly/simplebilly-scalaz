...
import SupplierConditionUpdate._
...
object SupplierConditionUpdate {
  import DateTimeCodecs._

  implicit val SupplierConditionUpdateCodecJson: CodecJson[SupplierConditionUpdate] = CodecJson.derive[SupplierConditionUpdate]
  implicit val SupplierConditionUpdateDecoder: EntityDecoder[SupplierConditionUpdate] = jsonOf[SupplierConditionUpdate]
  implicit val SupplierConditionUpdateEncoder: EntityEncoder[SupplierConditionUpdate] = jsonEncoderOf[SupplierConditionUpdate]
}
