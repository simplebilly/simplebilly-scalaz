...
object SilentPartner {
  import DateTimeCodecs._

  implicit val SilentPartnerCodecJson: CodecJson[SilentPartner] = CodecJson.derive[SilentPartner]
  implicit val SilentPartnerDecoder: EntityDecoder[SilentPartner] = jsonOf[SilentPartner]
  implicit val SilentPartnerEncoder: EntityEncoder[SilentPartner] = jsonEncoderOf[SilentPartner]
}
