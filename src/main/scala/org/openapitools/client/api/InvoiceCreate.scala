...
object InvoiceCreate {
  ...
  implicit val InvoiceCreateCodecJson: CodecJson[InvoiceCreate] = CodecJson.derive[InvoiceCreate]
  implicit val InvoiceCreateDecoder: EntityDecoder[InvoiceCreate] = jsonOf[InvoiceCreate]
  implicit val InvoiceCreateEncoder: EntityEncoder[InvoiceCreate] = jsonEncoderOf[InvoiceCreate]
}
