...
object Participation {
  ...
  implicit val ParticipationCodecJson: CodecJson[Participation] = CodecJson.derive[Participation]
  implicit val ParticipationDecoder: EntityDecoder[Participation] = jsonOf[Participation]
  implicit val ParticipationEncoder: EntityEncoder[Participation] = jsonEncoderOf[Participation]
}
